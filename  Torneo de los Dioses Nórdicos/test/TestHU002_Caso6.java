...
public class TestHU002_Caso6 {
    public static void main(String[] args) {
        System.out.println("Test: testEnfrentamientoDerrotaEspada");
        ...
        // Para probar derrota, verificamos si la vida se redujo
        if (!resultado && vidaFinal < vidaInicial) {
            ...
            System.out.println("Vida inicial: " + vidaInicial + ", Vida final: " + vidaFinal);
        } else {
